...
namespace Phpcq\PhpLocPluginTest;
 ...
 * @coversNothing
 */
final class PhpLocPluginTest extends TestCase
{
    private function instantiate(): DiagnosticsPluginInterface
    {
        return include dirname(__DIR__) . '/src/phploc.php';
    }

    public function testPluginName(): void
    {
        self::assertSame('phploc', $this->instantiate()->getName());
    }
